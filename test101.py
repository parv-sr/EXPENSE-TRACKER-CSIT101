...
root.configure(bg="#2e2e2e")  # Set the background color of the entire window
...
def open_new_window_addrecord():
    ...
    def validate_integer_input(int_val_amt):
        if int_val_amt == "":
            return True
    ...
    ttk.Label(new_window, text="Enter Details", background="#454746", foreground="white").grid(row=0, padx=10, pady=5, columnspan=2)

    ttk.Label(new_window, text="S.No.: ", background="#454746", foreground="white").grid(row=1, column=0, padx=20, pady=5, sticky="w")
    sno_entry = ttk.Entry(new_window, width=20, validate="key", validatecommand=vcmd)
    sno_entry.grid(row=1, column=1, padx=10, pady=5)

    ttk.Label(new_window, text="Date: ", background="#454746", foreground="white").grid(row=2, column=0, padx=20, pady=5, sticky="w")
    date_entry = DateEntry(new_window, width=20)
    date_entry.grid(row=2, column=1, padx=10, pady=5)

    ttk.Label(new_window, text="Category:", background="#454746", foreground="white").grid(row=3, column=0, padx=20, pady=5, sticky="w")
    ...
    ttk.Label(new_window, text="Amount:", background="#454746", foreground="white").grid(row=4, column=0, padx=20, pady=5, sticky="w")
...
btn_add_record = tk.Button(frame1, text="+", font=("Arial", 14), bg="#1f1f1f", fg="white", command=open_new_window_addrecord)
btn_add_record.grid(row=0, column=3, padx=5, pady=5, sticky="nsew")

btn_delete_record = tk.Button(frame1, text="\U0001F5D1", font=("Arial", 14), bg="#1f1f1f", fg="white", command=deleteRecord)
btn_delete_record.grid(row=0, column=4, padx=5, pady=5, sticky="nsew")

btn_edit_record = tk.Button(frame1, text="Edit", font=("Arial", 14), bg="#1f1f1f", fg="white", command=open_new_window_editrecord)
